        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1">
            <div className="flex flex-col items-center bg-white rounded">
                ...
                <div className="flex flex-col items-center mt-8">
                    <img className="h-[3rem] w-[3.5rem]" src="earth.png" alt="error" />
                    <h4 className="text-[#000054] mt-4">Company Management System</h4>
                </div>
            ...
            <div className="rounded">
                <img className="rounded h-[41rem]" src="login.svg" alt="error" />
            </div>
        </div>
    );
};
